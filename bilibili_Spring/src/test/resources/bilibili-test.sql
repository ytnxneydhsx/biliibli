...
CREATE TABLE IF NOT EXISTS `t_video_upload_task` (
    ...
    `total_chunks` INT NOT NULL COMMENT 'total chunk count',
    `status` TINYINT(1) DEFAULT 0 COMMENT '0 uploading,1 merging,2 done,3 expired,4 failed',
    `temp_dir` VARCHAR(255) NOT NULL COMMENT 'relative temp dir',
