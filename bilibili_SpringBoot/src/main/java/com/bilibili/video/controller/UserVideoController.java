...
public class UserVideoController {
    ...
    @Autowired
    public UserVideoController(VideoApplicationService videoApplicationService) {
    ...
    public Result<PageVO<VideoVO>> listPublishedVideos(@PathVariable("uid") Long uid,
        ...
        return Result.success(PageVO.from(videoApplicationService.listPublishedVideos(uid, title, pageQuery)));
    }
}
